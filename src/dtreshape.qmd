...
Using the same example seen in @sec-dfReshaping:
...
Using the same synthetic data as in @sec-dfReshaping:
...
- [Efficient reshaping using data.table](https://rdatatable.gitlab.io/data.table/articles/datatable-reshape.html)
