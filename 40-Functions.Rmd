...
Let's start with a very simple function: single argument, no default:
...
You could use `return()`, but it's not necessary if you want to return the last object defined within the function.
