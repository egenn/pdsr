...
Before starting to use the above function, we need to learn about anonymous functions, which are often used within the apply functions.
...
In `lapply()`, `sapply()` and `vapply()` you can iterate over an integer sequence instead of directly on an object:
