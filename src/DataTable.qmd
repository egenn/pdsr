...
<!-- FIXME: Does the read of the book really need to know how to install the development version? /HB 2023-09-27 -->
...
To get the latest development version, you can use either `pak` or `remotes`:
...
<br><br>
The 
[data.table installation wiki](https://github.com/Rdatatable/data.table/wiki/Installation#openmp-enabled-compiler-for-mac) described how to enable OpenMP
...
If all works correctly, when you now load the library, it will inform you
