...
Any time you are working with data, you have to first ensure, it's in the correct data type.
<br><br>
...
However, in lists, and therefore also data frames (see Chapter @sec-dataframes), replacing an 
