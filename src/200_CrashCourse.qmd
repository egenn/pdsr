...
This is for the UCSF DCR Intro to R
...
For a more thorough coverage of the topic, see the [Programming for Data Science in R](https://class.lambdamd.org/pdsr/) book.
