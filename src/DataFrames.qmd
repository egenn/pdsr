...
R's data.frame is the main object used to hold data for statistical analysis, 
visualization, and predictive modeling.

See the [Data frames](#dataframestruc) section in the 
[Data Structures](#sec-DataStructures) chapter for basic info on data.frames.
