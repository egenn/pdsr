...
This is the beginning of an intro chapter to dplyr.
...
version of the same "verb". It has undergone many major changes since its introduction, so always 
make sure to consulte the latest documentation. Some of the welcome recent changes aim to reduce
...
Note that dplyr masks a number of builtin function when loaded.
