...
Logical vectors consist of `TRUE` and `FALSE` values.
One importance use of logical vectors is in indexing (@sec-indexing).

When you are writing code, use `TRUE` and `FALSE`.  
During interactive qwork, you can abbreviate to `T` and `F`.
