...
| **List**        | 1-D; can be nested | heterogeneous   | a collection of any R objects, each of any length
| **Data frame**  | 2-D                | heterogeneous   | a special kind of list: a collection of (column) vectors of any type, all of the same length
