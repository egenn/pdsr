...
(because the **datasets** package is automatically loaded)  
...
You can execute a command of you operating system (OS) -i.e. MacOS, Linux, 
Windows- from within R using the `system()` function:
...
```{r FigRDataIO, echo = FALSE, out.width = "80%", fig.align = 'center', fig.cap = "Common Data Input/Output commands in R"}
