...
Segments of code may be repeated multiple times (`for`) or as long as certain 
...
build up to any amount of complexity.
...
`ifelse()` is [vectorized](#vectorization) and can be a great and compact 
...
### Select among multiple options with `switch()`
