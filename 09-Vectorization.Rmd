...
Most builtin R functions are vectorized. This is very efficient: it saves both human (your) time and machine time.  
Functions from 3rd party packages are often vectorized as well. Check each function's help file before using.   
