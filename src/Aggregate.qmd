...
The function accepts either a formula or R objects like data.frames and vectors. 

We shall see how to perform each operation below with 
either approach. 

The formula interface might be easier to work with 
interactivly on the console. While you *can* code with the formula interface, 
it is quite a bit more involved.

For this example, we shall use the penguin data from **palmerpenguis**:
