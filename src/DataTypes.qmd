...
A vector is one-dimensional array, i.e. a collection of elements.
<br><br>
For example, a vector can contain the numbers `12, 14, 20`, or the 
characters `x, y, z`.
<br><br>
All data in R is stored in vectors. These can be stand-alone, i.e. a 
1-D collection of items of the same type (e.g. numeric, character, etc.), 
or within another data structure, e.g. a data.frame, list, etc.

This chapter covers different data types, i.e. vectors, and next covers data 
