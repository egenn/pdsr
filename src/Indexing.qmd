...
ways to index structures of any dimension, whether 1-, 2-, or N-dimensional. There are often 
...
regular indexing. The syntax is `data[condition, ]`, where `condition` is a logical
