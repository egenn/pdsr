...
<!-- FIXME: In recent R versions, we can use `_` as a place holder 
     similar to `.` in magrittr /HB 2023-09-27 -->
Also, by design, native pipe only pipes its LHS to the first ***unnamed*** argument 
...
<!-- FIXME: Stray paragraph?!? /HB 2023-09-27 -->
