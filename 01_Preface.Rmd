...
which supports multiple character ligations that make code prettier / easier to read.

```{r, echo = FALSE, out.width = "75%", fig.align = "center", fig.cap = "Note ligated versions of some common character combinations as they should appear in this site"}
