...
However, in lists and therefore data frames, replacing an element with `NULL` ***removes that element***:
...
Finally, `NULL` is sometimes used as the default value in a function's argument. The function definition must then determine what the default behavior/value should be.
