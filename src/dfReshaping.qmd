...
#| the left with 3 cases (3 IDs) and 3 variables can be represented as a 3 x 4
...
with the jargon.
<br><br>
This chapters include detailed diagrams and step-by-step instructions to explain 
how to build calss for long-to-wide and wide-to-long reshaping.
...
Use the following figure to understand `reshape()`'s wide-to-long syntax. You 
can use it as a reference when building a call to `reshape()` by following 
