...
dat_wide2long <- reshape(data = dat_wide,                    # Data in wide format
                         idvar = "ID",                       # The column name that defines case ID
