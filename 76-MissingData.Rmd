...
It may be helpful to visualize missing data to get a quick impression of missingness. 
The [**rtemis**](https://rtemis.lambdamd.org/) package includes `mplot.missing()`:
