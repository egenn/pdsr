...
<!-- FIXME: 1-D, 2-D, ... is used in table but 1D, 2D, ... in text /HB 2023-09-27 -->
...
<!-- FIXME: 
  NA is logical here, which means it will create a logical matrix.
  That will be coerced upon first assignment, which is very inefficient
  (https://www.jottr.org/2014/06/17/matrixna-wrong-way/). The proper way
  is to use NA_real_.  To avoid introducing that here, maybe use another
  example? /HB 2023-09-27
-->
```{r}
