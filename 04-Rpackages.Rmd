...
[RStudio](https://rstudio.com/) is a very popular and mature Integrated Development Environment ([IDE](https://en.wikipedia.org/wiki/Integrated_development_environment)) for R, which can make work in R easier, more productive, and, importantly, more fun. This is the recommended environment to use, especially for beginners. Make sure to keep your installation up-to-date; new features are added often.  
