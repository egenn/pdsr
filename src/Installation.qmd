...
[mamba](https://mamba.readthedocs.io/en/latest/installation.html). This might appeal to 
you if you are already using conda/mamba to install Python and other software.
