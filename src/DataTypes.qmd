...
<br><br>
Vectors can exist as stand-alone objects, or they can exist within another data 
structure, e.g. a data.frame, list, etc.
...
Users can, however, define their own classes - see @sec-classes.
<br><br>
...
Other data types include environments and closures (functions - see @sec-functions). 
