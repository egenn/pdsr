...
You can use the `levesl()` command with an assignment to assign new labels to a factor (same syntax to how you use `rownames()` or `colnames()` to assign new row column names to a matrix/data frame)
