...
Many algorithms, or their implementations, do not support categorical variables directly. To use them, you must therefore convert all categorical variables to some type of numerical encoding.
