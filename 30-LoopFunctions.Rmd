...
Notice that in the alternative approach, since you are not passing the object (iris, here) as the input to `lapply()`, it needs to be specified within the anonymous function.
