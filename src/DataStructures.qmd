...
| **Vector**      | 1-D                | homogeneous              |
| **List**        | 1-D; can be nested | heterogeneous            |
| **Data frame**  | 2-D                | A special kind of list; heterogeneous collection of columns |


Homogeneous vs. hetereogeneous refers to the kind of data types 
(see @sec-datatypes), e.g. integer, double, character, logical, factor, etc., 
that a structure can hold. This means a matrix can hold only numbers or only characters, but a data frame can hold 
...
Since each element can be any object, it is easy to build a nested 
list:
