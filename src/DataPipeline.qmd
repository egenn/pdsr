...
- Using R's [`csv.read()`, `read.table()`](https://class.lambdamd.org/pdsr/DataIO.html#csv)
...
If you have data in multiple files that need to be merged, you can easily joing them:
